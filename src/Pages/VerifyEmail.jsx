        ...
        <div className="w-screen min-h-[calc(100vh-3.75rem)] flex flex-col justify-center items-center gap-4">
          <div className="max-w-[500px] p-10 ">
            ...
            <form onSubmit={handleOnSubmit} className="text-white">
              <OTPInput
                ...
                inputStyle={{
                  width:"50px",
                  height:"50px" ,
                  borderRadius: "8px", border: "1px solid #F1F2FF",
                  fontSize:"1.5rem", textAlign:"center",
                  backgroundColor:"#161D29", color:"#FFFFFF" ,
              ...
              />
              <button className="w-full py-3 bg-yellow-50 my-5 rounded-md text-richblack-900 text-[16px] font-semibold" type="submit">Verfify Email</button>
            </form>
            ...
            <div className="flex justify-between items-center">
              ...
              <button onClick={() => dispatch(sendOTP(signupData.email))} className="flex gap-2 items-center text-blue-100">
              <FaHistory />
                Resend it
              </button>
            </div>
