...
const About = () => {
  return (
    <div className="text-white  mx-auto">
      ...
      <section className="">
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500">
          ...
          <div className="flex flex-col items-center gap-10 lg:flex-row justify-between">
            {/* left side */}
            <div className="my-24 flex lg:w-[45%]  flex-col gap-10 px-10">
              <h1 className="bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%] ">
                Out Founding Story
              </h1>
              <p className="text-[16px] font-semibold text-richblack-300">
          ...
          {/* vision and mission  */}
          <div className="flex px-10 justify-between w-full gap-10 mb-20">
            {/* left side */}

            <div className="w-[80%] p-x-10">
      ...
      {/* section 5 */}
      <section className="mx-auto p-2 flex flex-col items-center  gap-5 mb-[140px]">
        <LearningGrid />
        <ContactFormSection />
      </section>
